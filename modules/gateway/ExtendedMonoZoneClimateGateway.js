...
function buildExtendedMonoZoneCharacteristics(opts) {
    ...
    chars.push((0, catalog_1.iconIdField)(MP, '_iconId'), (0, catalog_1.stateBool)(MP, 'isLockFunctionEnabled', 'Lock Function', { settable: true }), ...(0, catalog_1.demandControlPack)(MP));
    return chars;
}
